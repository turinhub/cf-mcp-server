/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 80415ca3600b4e5886eff1e16bad22f0)
// Runtime types generated with workerd@1.20250525.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TAVILY_API_TOKEN: string;
		BEARER_TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").TavilyMCP>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TAVILY_API_TOKEN" | "BEARER_TOKEN">> {}
}
